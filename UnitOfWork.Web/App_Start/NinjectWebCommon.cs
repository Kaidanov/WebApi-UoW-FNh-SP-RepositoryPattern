[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(UnitOfWork.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(UnitOfWork.Web.App_Start.NinjectWebCommon), "Stop")]

namespace UnitOfWork.Web.App_Start
{
    using System;
    using System.Web;
